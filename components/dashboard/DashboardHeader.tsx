...
export const DashboardHeader: React.FC<DashboardHeaderProps> = ({
  ...
  const isGuideStep1 = guideStep === 1;
  ...
  <div className="bg-white rounded-2xl p-4 md:p-12 shadow-sm border border-gray-100">
    ...
    <button
      ...
      className={`w-full md:w-auto bg-primary text-white px-6 md:px-8 py-3 rounded-full hover:bg-[#1e2b1e] transition-all shadow-lg shadow-primary/20 hover:shadow-primary/40 text-sm md:text-base font-medium flex items-center justify-center gap-2 ${isGuideStep1 ? 'ring-4 ring-accent shadow-primary/60 scale-[1.02]' : ''}`}
    >
